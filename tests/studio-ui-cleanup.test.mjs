...
test("selected assets use a compact left list and right-side properties panel", () => {
  ...
  assert.match(layerInspector, /ChevronsUp/);
  assert.match(layerInspector, /ChevronUp/);
  assert.match(layerInspector, /ChevronDown/);
  assert.match(layerInspector, /ChevronsDown/);
