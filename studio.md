...
**Inspector section langsung dari canvas (25 September 2026):** setiap section visual undangan—Amplop, Cover, Salam, Identitas, Detail Acara, Tanggal & Waktu, Galeri, Countdown, Lokasi, RSVP, Ucapan Tamu, Hadiah, Penutup, dan Footer—dapat dipilih langsung dengan klik area section pada canvas. Section terpilih mendapat outline Rose dan membuka **panel properti ringkas di kanan paling ujung canvas**, memakai area yang sama dengan inspector asset; klik asset mengalihkan inspector ke asset dan klik section mengalihkan inspector ke section. Panel section tidak boleh dipindah ke kiri seperti referensi aplikasi lain.

Kontrol umum section pada tahap ini: **Perataan Kiri/Tengah/Kanan**, input **Ruang Vertikal**, slider **Opasitas**, override **warna latar**, tombol **Reset section**, dan tombol ✕ untuk melepas seleksi. Override section menjadi bagian dari `InvitationDesignState`, ikut Undo/Redo, snapshot refresh, tombol Simpan, serta public renderer; mengganti template atau Restart penuh membersihkannya. Untuk section fungsional seperti RSVP, Ucapan Tamu, Lokasi, Countdown, Galeri, dan Hadiah, panel boleh menampilkan ringkasan fungsi terlindungi tetapi **jangan memutus API, validasi, data event, submit, QR, maps, timer, rekening, atau endpoint** demi kebebasan visual. Detail editor field-level seperti referensi RSVP dikembangkan di atas fondasi ini dengan capability yang aman, bukan dengan menghapus elemen wajib secara bebas.
