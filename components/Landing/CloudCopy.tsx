...
export default function CloudCopy({ corner }: { corner: "top" | "bottom" }) {
  ...
  return (
    <motion.div
      ...
      className={top
        ? "absolute left-1/2 top-[clamp(12px,3dvh,32px)] z-20 w-[min(88%,390px)] -translate-x-1/2 sm:left-[3%] sm:top-2 sm:translate-x-0 lg:left-[4%] lg:top-[6%] lg:w-[min(28vw,460px)]"
