...
export default function PortalTransition() {
  ...
  return <div aria-hidden="true" className="pointer-events-none fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden">
    <div className="absolute inset-0 bg-[#f9e9ee] dark:bg-[#241b20]"
      style={{ opacity: phase === "cover" ? 0 : 1, transition: phase === "cover" ? `opacity ${COVER_MS}ms ease-in` : "none" }} />
    ...
    {phase === "reveal" && <div className="absolute inset-0 bg-[#f9e9ee] dark:bg-[#241b20]"
      style={{ animation: `dc-portal-clear ${REVEAL_MS}ms ease-in-out both` }} />}
  </div>;
}
