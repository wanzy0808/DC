...
export const EMPTY_EVENT_FORM: EventForm = {
  ...
  ceremonyTime: "",
  receptionTime: "",
  weddingCeremonyEnabled: false,
  weddingReceptionEnabled: false,
...
export function eventInvitationToForm(
  ...
  return {
    ...
    weddingCeremonyEnabled: invitation.weddingCeremonyEnabled || false,
    weddingReceptionEnabled: invitation.weddingReceptionEnabled || false,
    weddingCeremonyStart: invitation.weddingCeremonyStart || "",
    weddingCeremonyEnd: invitation.weddingCeremonyEnd || "",
    weddingCeremonyVenue: invitation.weddingCeremonyVenue || "",
    weddingCeremonyAddress: invitation.weddingCeremonyAddress || "",
    weddingCeremonyMapUrl: invitation.weddingCeremonyMapUrl || "",
    weddingReceptionStart: invitation.weddingReceptionStart || "",
    weddingReceptionEnd: invitation.weddingReceptionEnd || "",
    weddingReceptionVenue: invitation.weddingReceptionVenue || "",
    weddingReceptionAddress: invitation.weddingReceptionAddress || "",
    weddingReceptionMapUrl: invitation.weddingReceptionMapUrl || "",
