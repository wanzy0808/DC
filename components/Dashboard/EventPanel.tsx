...
export default function EventPanel({ accent, onSaved }: Props) {
  ...
  async function load(nextType: InvitationType) {
    ...
    try {
      ...
      setNotice("Data acara tersimpan di database. Nama pasangan mengikuti onboarding.");
    } catch (error) {
