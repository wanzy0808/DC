...
function SheetClose({ ...props }: SheetPrimitive.Close.Props) {
  // SheetClose is also used with Next.js <Link> via Base UI's `render` prop.
  // Base UI otherwise assumes a native <button> and logs an accessibility warning.
  // Consumers that need a native button can still explicitly pass nativeButton={true}.
