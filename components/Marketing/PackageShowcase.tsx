          ...
          return (
            <article
              ...
              className={`relative flex h-full flex-col rounded-3xl border p-6 md:p-7 ${
                featured
                  ? "border-[var(--primary)] bg-[var(--primary)]/[0.07] shadow-[0_20px_60px_rgba(122,28,37,0.12)]"
                  : "border-[var(--border)] bg-[var(--card)]/75"
              }`}
            >
              {featured ? (
                <span className="absolute right-5 top-5 rounded-full bg-[var(--primary)] px-3 py-1 text-[10px] font-mono uppercase tracking-wider text-white">
                  Paling lengkap
                </span>
              ) : null}
              ...
              <Link
                href="/packages"
                className={`mt-7 inline-flex items-center justify-center gap-2 rounded-full px-5 py-3 text-xs font-semibold uppercase tracking-[0.16em] transition ${
                  featured
