...
export default function RegisterDialog({ isDarkMode, onSwitchToLogin }: RegisterDialogProps) {
  ...
  const next = searchParams.get("next")?.startsWith("/") && !searchParams.get("next")?.startsWith("//") ? searchParams.get("next")! : "/dashboard";
