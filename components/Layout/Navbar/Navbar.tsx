...
export default function Navbar({ embedded = false }: { embedded?: boolean }) {
  ...
  const isLanding = pathname === "/" || isJiplak || (embedded && pathname === "/d-invitation");
  if ((!embedded && (pathname === "/" || pathname === "/pagecontoh" || pathname === "/d-invitation")) || pathname === "/dashboard" || pathname.startsWith("/dashboard/")) return null;
