...
export default function MarketingFloatingControls() {
  ...
  if (!isMarketingPath(pathname) || pathname === "/" || pathname === "/pagecontoh" || pathname === "/d-invitation" || pathname === "/template-design" || pathname === "/event-planner" || pathname === "/guestbook" || pathname === "/undangan-fisik") return null;
  return <>
