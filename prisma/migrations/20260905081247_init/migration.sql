-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'EDITOR', 'SUPPORT', 'FINANCE', 'OWNER', 'ADMIN');

-- CreateEnum
CREATE TYPE "InvitationType" AS ENUM ('WEDDING', 'ADAT_AKAD');
...
-- CreateIndex
CREATE INDEX "Invitation_ownerId_type_idx" ON "Invitation"("ownerId", "type");
