export const invitationPalettes = {
  ...
  mauve: { name: "Mauve", bg: "#f4edf2", surface: "#fcf7fb", ink: "#30252e", accent: "#8c607d", soft: "#c9a5ba" },
...
export const invitationFonts = {
  ...
  crimsonDmSans: { name: "Crimson Pro + DM Sans", heading: "Crimson Pro", body: "DM Sans" },
  ...
  playfairQuicksand: { name: "Playfair Display + Quicksand", heading: "Playfair Display", body: "Quicksand" },
  playfairInter: { name: "Playfair Display + Inter", heading: "Playfair Display", body: "Inter" },
