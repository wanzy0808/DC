...
**Pengecualian dan validasi:** Kontrol menu, pemilih daftar/foto, data RSVP, serta artwork undangan/landing/Pintu tidak diubah. Tidak ada migrasi database. CI sukses untuk perubahan Dashboard pada commit `e7f17727` (`https://github.com/wanzy0808/DC/actions/runs/35846550241`); hasil CI setelah perluasan Studio dicatat bila sudah tersedia. Pemeriksaan visual browser nyata Light/Dark dan seluler belum dilakukan.
