...
**Scope:** Semua instance burger navbar yang sudah memakai `BurgerMenuContent` (Home embedded dan halaman marketing/publik lainnya), bukan dashboard sidebar. Tidak mengubah sesi/database/API login/logout, entitlement, gambar pintu atau styling public navbar; tidak perlu migrasi DB. Pemeriksaan browser dengan sesi pengguna nyata dan logout tetap diperlukan selain CI.
