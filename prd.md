...
Affected source: `components/Landing/Pintu/reference-door-engine.js`, `components/Landing/Pintu/ReferenceDoorPreview.tsx`, `app/pintu-lab/page.tsx`; docs: `pintu3d.md`, `prd.md`. Source commit GitHub: `e6ab1491453b02f0e8703e114fb77a7df2358393`. Validation observed locally: engine syntax check **PASS**; targeted ESLint **PASS**; Next.js production build **PASS** (54 static pages generated). GitHub Build Validation and owner visual review are **pending**; do not treat build success as fidelity approval.
