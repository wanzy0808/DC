...
**Pengecualian:** Chrome navbar/sidebar/account menu, tombol ikon khusus, pilihan item daftar/template yang merupakan row selectable (bukan CTA), filter dan input tidak diubah. Tidak ada migrasi database, pengubahan fitur, perubahan landing/Pintu atau artwork undangan. **Validasi:** GitHub Actions commit kode `e7f17727` sukses (`https://github.com/wanzy0808/DC/actions/runs/35846550241`), termasuk tes existing dan production build; pemeriksaan visual browser nyata Light/Dark dan seluler belum dilakukan.
