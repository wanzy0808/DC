...
Affected source: `components/Landing/Pintu/reference-door-engine.js`, `components/Landing/Pintu/ReferenceDoorPreview.tsx`, `app/pintu-lab/page.tsx`; docs: `pintu3d.md`, `prd.md`. Source commit: `41d19feaa55c15377efae3fb226cacbda708410e`. Validation observed locally: engine syntax check **PASS**; targeted ESLint **PASS**; Next.js production build **PASS** (54 static pages generated). GitHub Build Validation and owner WebGL screenshot/review are **pending**; local build is not visual approval.
