...
export async function GET() {
  ...
  if (!invitation || !(await hasAccountDigitalInvitation(user.id, invitation.payment))) return NextResponse.json({ error: "Export tamu membutuhkan paket Digital Invitation." }, { status: 402 });
