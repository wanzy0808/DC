...
## 22 September 2026 — Pintu dibuang hanya dari fase transisi

Delta:
- Pintu di landing, orbit, pilihan layanan dan bukaan sebelum `Masuk` tetap ada;
- setelah `Masuk`, scene Pintu langsung fade 150 ms dan kamera tidak lagi zoom/terbang melewati kusen;
- Rose veil, sound lembut dan puzzle assembly halaman tujuan menjadi satu-satunya visual perpindahan;
- route handoff dipercepat dan memiliki recovery bila navigasi gagal.

Validation: targeted ESLint, TypeScript, dan Next.js production build PASS (58 route); preview visual/sound timing pending.
